...
/*! MDrawing Plugin 2.1.1.26 */
(function(b,c){var a="2.1.1.26";M.plugin("drawing",{create:function(){var e,g,f=b,h={};e=M.defaultSetting.create({paramsKeys:["callback"],defaultSetting:{savePoint:"APPINSIDE",path:"",format:"PNG",privacy:false,orientation:"DEFAULT",userInterfaceType:"DEFAULT",saveSizeIndex:"",callback:function(j,i){}},surrogateKeys:{alias:"path",source:"path",donecb:"callback",uitype:"userInterfaceType",orient:"orientation",orientationType:"orientation",done:"callback",ondone:"callback",onsave:"callback"},enumsKeys:{savepoint:{APPINSIDE:0,APPOUTSIDE:1},format:{PNG:0,JPG:1},userInterfaceType:{DEFAULT:0,BUTTON:1},orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5}}});g=e.convert(arguments);var d=M.response.on(function(j,i){g.callback.call(f,j,i,g)});h.callback=d.toString();h.savePoint=g.savePoint;h.privacy=g.privacy===true?"YES":"NO";h.format=g.format;h.saveSizeIndex=g.saveSizeIndex;h.userInterfaceType=g.userInterfaceType;h.orientation=g.orientation;if(g.path){h.path=g.path}M.execute("wn2PluginDrawingCreate",h);return M},open:function(){var e,g,f=b,h={};e=M.defaultSetting.create({paramsKeys:["callback"],defaultSetting:{savePoint:"APPINSIDE",path:"",format:"PNG",privacy:false,orientation:"DEFAULT",userInterfaceType:"DEFAULT",saveSizeIndex:"",callback:function(j,i){}},surrogateKeys:{alias:"path",source:"path",uitype:"userInterfaceType",orient:"orientation",orientationType:"orientation",donecb:"callback",done:"callback",ondone:"callback",onsave:"callback"},enumsKeys:{savepoint:{APPINSIDE:0,APPOUTSIDE:1},format:{PNG:0,JPG:1},userInterfaceType:{DEFAULT:0,BUTTON:1},orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5}}});g=e.convert(arguments);var d=M.response.on(function(j,i){g.callback.call(f,j,i,g)});h.callback=d.toString();h.savePoint=g.savePoint;h.privacy=g.privacy===true?"YES":"NO";h.format=g.format;h.userInterfaceType=g.userInterfaceType;h.orientation=g.orientation;h.saveSizeIndex=g.saveSizeIndex;if(g.path===""&&M.media){M.media.library({media:"PHOTO",choose:"SINGLE"},function(j,i){if(j==="SUCCESS"){h.path=i.path;setTimeout(function(){M.execute("wn2PluginDrawingOpen",h)},500)}else{d.execute([])}})}else{h.path=g.path;M.execute("wn2PluginDrawingOpen",h)}return M}},a)})(window);(function(){var a=null;var b="__WPAINT_RESULT_BASE64";M.drawing._WPAINT_PARAMKEY=b;M.onRestore(function(){if(a){const c=M.data.global(b);M.data.removeGlobal(b);a(c?"SUCCESS":"FAIL",c);a=null}});M.drawing.wpaint=function(){var c,e,d=window,f={};c=M.defaultSetting.create({paramsKeys:["callback"],defaultSetting:{imagePath:"",orientation:"DEFAULT",callback:function(h,g){}},surrogateKeys:{},enumsKeys:{orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5}}});e=c.convert(arguments);a=e.callback;M.page.html({url:"/wpaint/index.html",param:{imagePath:e.imagePath},actionType:"NO_HISTORY",animation:"DEFAULT",orientation:e.orientation});f.orientation=e.orientation;return M}})();
...
/*! MDocViewer Plugin 2.1.1.11 [Android 2.1.1.11, iOS 2.1.1.11]  */
(function(b,c){var a="2.1.1.11";M.plugin("viewer.doc",{gview:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["url","title","orientation","animation"],defaultSetting:{url:"",title:"",orientation:"DEFAULT",animation:"DEFAULT"},surrogateKeys:{orient:"orientation",orientationtype:"orientation",animate:"animation",animationtype:"animation"},enumsKeys:{orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5},animation:{DEFAULT:0,NONE:1,SLIDE_LEFT:2,SLIDE_RIGHT:3,SLIDE_TOP:4,SLIDE_BOTTOM:5,ZOOM_IN:6,ZOOM_OUT:7,FADE:8,MODAL_UP:9,MODAL_DOWN:10}}});g=e.convert(arguments);if(g.url==""){return{status:"FAIL",message:"fail to open google document viewer. because url is empty."}}h.url=g.url;h.title=g.title;h.orientation=g.orientation;h.animation=g.animation;d=M.execute("wn2PluginViewerDocOpenWithGoogleDocsViewer",h);return d},open:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["path","title","orientation","animation","page"],defaultSetting:{path:"",title:"",orientation:"DEFAULT",animation:"DEFAULT",page:""},surrogateKeys:{alias:"path",source:"path",url:"path",orient:"orientation",orientationtype:"orientation",animate:"animation",animationtype:"animation"},enumsKeys:{orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5},animation:{DEFAULT:0,NONE:1,SLIDE_LEFT:2,SLIDE_RIGHT:3,SLIDE_TOP:4,SLIDE_BOTTOM:5,ZOOM_IN:6,ZOOM_OUT:7,FADE:8,MODAL_UP:9,MODAL_DOWN:10}}});g=e.convert(arguments);if(g.path==""){return{status:"FAIL",message:"fail to open document viewer. because path is empty."}}h.path=g.path;h.title=g.title;h.orientation=g.orientation;h.animation=g.animation;h.page=g.page;d=M.execute("wn2PluginViewerDocOpen",h);return d}},a)})(window);
